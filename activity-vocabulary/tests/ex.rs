...
mod vocab {
    ...
    gen_tests!(
        ...
        ex47 => WithContext<Relationship>,
        ex48 => WithContext<Article>,
        ex49 => WithContext<Document>,
        ex50 => WithContext<Audio>,
        ex51 => WithContext<Image>,
        ex52 => WithContext<Video>,
        ex53 => WithContext<Note>,
        ex54 => WithContext<Page>,
        ex55 => WithContext<Event>,
        ex56 => WithContext<Place>,
        ex57 => WithContext<Place>,
        ex58 => WithContext<Mention>,
        ex59 => WithContext<Profile>,
        ex60 => WithContext<OrderedCollection>,
    );
}
